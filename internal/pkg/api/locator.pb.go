...
type CourierList struct {
	...
	Points []*CourierGpsPoint `protobuf:"bytes,1,rep,name=points,proto3" json:"points,omitempty"`
}
...
var file_api_proto_v1_locator_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x12, 0x31, 0x0a, 0x06, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03,
